...
local function onCoinTouched(otherPart, coin)
    if coin:GetAttribute("Enabled") then
        ...
        if player then
            ...
            local coinsAmount = userData["Coins"] + 1
            PlayerData.updateData(player, "Coins", coinsAmount)

            Leadership.setLeaderboard(player, "Coins", coinsAmount)
